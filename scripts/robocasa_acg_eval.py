...
def run_episode(
    ...
    *,
    ...
    for t in range(horizon):
        ...
        action = convert_action(np.asarray(action_plan.popleft()))
        t0 = time.perf_counter()
...
def main() -> None:
    ...
    if gym is None or get_task_horizon is None or convert_action is None:
        raise ImportError(
    ...
    run_config = vars(args) | {"buckets": buckets, "plan": {k: plan[k] for k in buckets}}
